# RailsAdmin config file. Generated on November 15, 2013 12:23
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Testing', 'Admin']
  ...
  # config.excluded_models = ['Address', 'Admin', 'CompanyProfile', 'CompanyUser', 'Locatable', 'Transaction', 'User', 'Vehicle']

  # Include specific models (exclude the others):
  # config.included_models = ['Address', 'Admin', 'CompanyProfile', 'CompanyUser', 'Locatable', 'Transaction', 'User', 'Vehicle']
  ...
  #     configure :locatables, :has_many_association 
  ...
  # config.model 'CompanyProfile' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your company_profile.rb model definition

  #   # Found associations:

  #     configure :company_users, :has_many_association 
  #     configure :vehicles, :has_many_association 
  #     configure :transactions, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your company_user.rb model definition

  #   # Found associations:

  #     configure :company_profile, :belongs_to_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :company_profile_id, :integer         # Hidden 
  ...
  # config.model 'Locatable' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your locatable.rb model definition
  ...
  #     configure :vehicle, :belongs_to_association 
  ...
  #     configure :id, :integer 
  #     configure :pickup_address, :string 
  #     configure :dropoff_address, :string 
  #     configure :pickup_date, :date 
  #     configure :pickup_time, :time 
  #     configure :dropoff_date, :date 
  #     configure :dropoff_time, :time 
  #     configure :vehicle_id, :integer         # Hidden 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your vehicle.rb model definition
